/*
 ...
 Copyright : UniversitÃ© de Sherbrooke
    ...
    while (1) {
        if (inputBufferFull) {
            ...
            if (SWT_GetValue_Local(0) == 0) { // MAIN DECISION TREE: PASS-THROUGH
                ...
                // Test -> signal entrée = 2000 hz| résultat obtenue maxAmplFreq = 1996 Hz, 2011Hz en debug
                // afficher 7segment est quasiment +- 10hz de différence de la fréquence du signal à l'entrée
